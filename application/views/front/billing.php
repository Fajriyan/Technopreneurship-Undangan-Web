					...
					<div class="bill-to">
						...
						<div class="form-two">
							<form action="<?php echo base_url() ?>update-billing" method="post" name="billing_info">
								...
								<input type="text" placeholder="Nomor Handphone*" name="cus_mobile" value="<?php echo $cus_info->cus_mobile ?>">
								<input type="text" placeholder="Alamat Lengkap*" name="cus_address" value="<?php echo $cus_info->cus_address ?>">
								<input type="text" placeholder="Kabupaten" name="cus_city" value="<?php echo $cus_info->cus_city ?>">
