...
<?php } else { ?>
    ...
    <body>
        <!--  wrapper -->
        <div id="wrapper" style="background: dimgray">
            <!-- navbar top -->
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar" style="background: dimgray">
                <!-- navbar-header -->
                <div class=" navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <h1 style="color: wheat">Halaman Admin</h1>
                    </a>
                </div>
                <!-- end navbar-header -->
                <!-- navbar-top-links -->
            ...
            <!-- navbar side -->
            <nav class="navbar-default navbar-static-side" role="navigation" style="background: dimgray">
                <!-- sidebar-collapse -->
                <div class="sidebar-collapse" style="background: dimgray">
                    <!-- side-menu -->
                    <ul class="nav" id="side-menu">
                        <li>
                            <!-- user image section-->
                            <div class="user-section" style="background: black">
                                ...
                                <div class="user-info" style="color: white">
                                    ...
                                    <div class="user-text-online" style="color: white">
                        ...
                        <li class="sidebar-search" style="background: #000120">
                            <!-- search section-->
                        ...
                        <li class="selected" style="background: dimgray">
